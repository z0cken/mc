...
public class DatabaseHelper {
    ...
    DatabaseHelper() {
        try {
            ...
            Configuration config = PCS_Checkpoint.getInstance().config.getSection("database");
    ...
    static void verify(String message, String name) {
        ...
        if(valid) {
            ...
            if(usernameExists(name)) {
                BungeeCord.getInstance().getLogger().warning(name + "tried to verify " + uuid + " but is already linked!");
                return;
            }
